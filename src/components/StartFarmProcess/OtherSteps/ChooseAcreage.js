    ...
    <Grid templateColumns="repeat(2, 1fr)" gap={6} padding={10}>
      ...
      <Box>
        ...
        >
          ...
          <Text>
            Weather Sandy loam soil is one of the most preferable types of soil
            for many types of plants. Planting in loam soil with a high
            percentage of sand is the same as planting in normal loam soil, but
            extra amendments may be made to compensate for slightly lower water
          </Text>
        </Box>
        <Box marginTop="10">
        ...
        <Box marginTop="10">
          <Heading as="h5" size="sm">
            Do you want allow cycle for this farm?
          </Heading>
          <Stack direction="row">
