...
const KPIArray = ({ fieldName, fieldObj, values, errors, touched, handleChange, handleBlur, label, title }) => (
                                ...
                                <Grid templateColumns={{ md: 'repeat(2, 1fr)' }} gap={4}>
                                        {values?.map((value, i) => (
                                                <ThirdPartyInput
                                                        ...
                                                        errors={
                                                                errors &&
                                                                errors.thirdPartyRef &&
                                                                errors.thirdPartyRef[i]
                                                        }
                                                        touched={
                                                                touched &&
                                                                touched.thirdPartyRef &&
                                                                touched.thirdPartyRef[i]
                                                        }
                                                />
                                        ))}
                                </Grid>
