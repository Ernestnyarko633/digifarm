...
const FormTextArea = ({ label, value, onChange, onBlur, placeholder, name, type, error, touched }) => (
        <FormControl pos="relative" pt={2} isInvalid={error && touched}>
                <Box
                        ...
                        borderTopWidth={0}
                >
                        <FormLabel fontSize={{ md: 'sm' }} pos="absolute" left={{ md: 4 }} top={-1} color="gray.600">
                                {label}
                        </FormLabel>
                        <Textarea
                                value={value}
