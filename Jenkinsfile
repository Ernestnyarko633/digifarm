            ...
            if (env.BRANCH_NAME == 'dev' || env.BRANCH_NAME == 'master' || env.BRANCH_NAME == 'demo'){
                    ...
                    */
                    lock('EnvironmentTagging'){
                        ...
                        * docker build on the command line */
                        app = docker.build("263926175602.dkr.ecr.ap-south-1.amazonaws.com/cf-server", "--build-arg REACT_APP_ENVIRONMENT=${run_environment} .")
                    }
                }
                ...
                stage('Push image') {
                    ...
                    */
                    ...
                    docker.withRegistry('263926175602.dkr.ecr.ap-south-1.amazonaws.com/cf-server', 'ecr:us-west-2:cf-aws-credentials') {
                        app.push(tag)
                    }
                }
